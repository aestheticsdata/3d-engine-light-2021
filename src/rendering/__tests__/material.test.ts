...
describe("the resolved channels", () => {
  ...
  it("agrees with its own fill string on every triangle of all twenty-three shapes", () => {
...
describe("the default material over the whole registry", () => {
  it("resolves every authored triangle in all twenty-three shapes to the colour it was authored with", () => {
    const shapes = Object.entries(data);

    expect(shapes).toHaveLength(23);
